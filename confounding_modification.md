...
<span style="color:gray"> Author: Benjamin Chase  
Last Edited: June 7, 2022  
Length: 10 min read</span>

## Table of contents

1.  [Causal Effects](#causaleffect)
2.  [Confounding](#confounding)
    -   [Example](#confoundingexample)
3.  [Effect Modification](#effectmodification)
    -   [Example](#effectmodificationexample)
4.  [Summary](#summary)

## What is a Causal Effect? <a name="causaleffect"></a>
...
## What is Confounding? <a name="confounding"></a>
...
### Example of Confounding <a name="confoundingexample"></a>
...
## What is Effect Modification? <a name="effectmodification"></a>
